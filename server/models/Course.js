...
function createDefaultCourses() {
    Course.find({}).exec(function (err, collection) {
        if(collection.length === 0) {
            ...
            Course.create({title: 'Super Duper Expert C#', featured: false, published: new Date('10/01/2013'), tags:['C#']});
            ...
            Course.create({title: 'Code Review for Jerks', featured: false, published: new Date('10/1/2013'), tags:['Coding']});
